 ...
 */
public class HelpChangjianActivity extends BaseActivity {
    ...
    protected int getActivityLayoutId() {
        return R.layout.activity_help_changjian;
    }

    public static void actionStart(Context context) {
        Intent intent = new Intent(context, HelpChangjianActivity.class);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        listview_xinshou.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                MessageHelpActivity.actionStart(HelpChangjianActivity.this, messageList.get(position).getId());
            }
        });
    }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonArray1.length() > 0) {
                        ...
                        adapter = new GongGaoAdapter(HelpChangjianActivity.this, messageList);
...
//        });
    ...
    protected void initImmersionBar() {
        ...
        if (!isSetTitle) {
            ImmersionBar.setTitleBar(HelpChangjianActivity.this, llTitle);
            isSetTitle = true;
        }
    }
}
