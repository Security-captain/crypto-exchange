 ...
 */
public class HelpHangqingActivity extends BaseActivity {
    @BindView(R.id.llTitle)
    LinearLayout llTitle;
    private GongGaoAdapter adapter;
    @BindView(R.id.listview_hangqing)
    LinListView listview_hangqing;
    ...
    protected int getActivityLayoutId() {
        return R.layout.activity_help_hangqing;
    }

    public static void actionStart(Context context) {
        Intent intent = new Intent(context, HelpHangqingActivity.class);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        listview_hangqing.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                MessageHelpActivity.actionStart(HelpHangqingActivity.this, messageList.get(position).getId());
            }
        });
    }
    ...
    private void getMessage() {
        WonderfulOkhttpUtils.post().url(UrlFactory.getHelpXinShou())
            ...
            public void onError(Request request, Exception e) {
                hideLoadingPopup();
                listview_hangqing.stopFreshing();
            }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonArray1.length() > 0) {
                        ...
                        adapter = new GongGaoAdapter(HelpHangqingActivity.this, messageList);
                        listview_hangqing.setEveryPageItemCount(20);
                        listview_hangqing.setAdapter(adapter);
                        listview_hangqing.setOnRefreshListener(new LinListView.OnRefreshListener() {
                            @Override
...
//        });
    ...
    protected void initImmersionBar() {
        ...
        if (!isSetTitle) {
            ImmersionBar.setTitleBar(HelpHangqingActivity.this, llTitle);
            isSetTitle = true;
        }
    }
}
