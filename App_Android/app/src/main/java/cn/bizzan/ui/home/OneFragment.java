...
public class OneFragment extends BaseTransFragment implements cn.bizzan.ui.home.MainContract.OneView, ICommonView {
...
//    TwinklingRefreshLayout refreshLayout;
    ...
    private void notLoginViewText() {
        try {
            ...
            text_login.setText(WonderfulToastUtils.getString(R.string.login_view));
        } catch (Exception e) {
