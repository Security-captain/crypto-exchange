...
public class AppealActivity extends BaseActivity implements AppealContract.View {
    ...
    private void appeal() {
        ...
        WonderfulDialogUtils.showDefaultDialog(this, WonderfulToastUtils.getString(R.string.Warm_prompt), WonderfulToastUtils.getString(R.string.paymentTip9), WonderfulToastUtils.getString(R.string.dialog_one_cancel), WonderfulToastUtils.getString(R.string.paymentTip10), null, new DialogInterface.OnClickListener() {
            @Override
