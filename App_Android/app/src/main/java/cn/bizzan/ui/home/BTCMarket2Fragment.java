...
public class BTCMarket2Fragment extends MarketBaseFragment implements ICommonView {
    ...
    public static BTCMarket2Fragment getInstance(int type) {
        BTCMarket2Fragment btcMarketFragment = new BTCMarket2Fragment();
...
//        });
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ((MarketOperateCallback) getActivity()).itemClick(BTCMarket2Fragment.this.adapter.getItem(position), type);
            }
        });
