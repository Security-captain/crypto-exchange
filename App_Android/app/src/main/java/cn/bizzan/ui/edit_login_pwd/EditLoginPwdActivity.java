...
//        });
    ...
    protected void fillWidget() {
        tvNumber.setText(WonderfulToastUtils.getString(R.string.changeLoginPasswordTip1)+ phone.substring(0, 3) + "****" + phone.substring(7));
    }
    ...
    private void fillCodeView(long time) {
        ...
        timer = new CountDownTimer(time, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                tvSend.setText(WonderfulToastUtils.getString(R.string.re_send)+"(" + millisUntilFinished / 1000 + "s)");
            }

            @Override
            public void onFinish() {
                tvSend.setText(WonderfulToastUtils.getString(R.string.send_code));
