 ...
 */
public class HelpJiaoyiActivity extends BaseActivity {
    @BindView(R.id.llTitle)
    LinearLayout llTitle;
    private GongGaoAdapter adapter;
    @BindView(R.id.listview_jiaoyi)
    LinListView listview_jiaoyi;
    ...
    protected int getActivityLayoutId() {
        return R.layout.activity_help_jiaoyi;
    }

    public static void actionStart(Context context) {
        Intent intent = new Intent(context, HelpJiaoyiActivity.class);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        listview_jiaoyi.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                MessageHelpActivity.actionStart(HelpJiaoyiActivity.this, messageList.get(position).getId());
            }
        });
    }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonArray1.length() > 0) {
                        ...
                        adapter = new GongGaoAdapter(HelpJiaoyiActivity.this, messageList);
                        listview_jiaoyi.setEveryPageItemCount(20);
                        listview_jiaoyi.setAdapter(adapter);
                        listview_jiaoyi.setOnRefreshListener(new LinListView.OnRefreshListener() {
                            @Override
...
//        });
    ...
    protected void initImmersionBar() {
        ...
        if (!isSetTitle) {
            ImmersionBar.setTitleBar(HelpJiaoyiActivity.this, llTitle);
            isSetTitle = true;
        }
    }
}
