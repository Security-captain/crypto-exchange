...
public class BindAccountActivity extends BaseActivity implements BindAccountContact.View {
    ...
    public void getAccountSettingSuccess(AccountSetting obj) {
        ...
        if (accountSetting.getAliVerified() == 0) {
            tvAli.setText(WonderfulToastUtils.getString(R.string.unbound));

        } else {
            tvAli.setText(WonderfulToastUtils.getString(R.string.bound));

        }

        if (accountSetting.getWechatVerified() == 0) {
            tvWeiChat.setText(WonderfulToastUtils.getString(R.string.unbound));

        } else {
            tvWeiChat.setText(WonderfulToastUtils.getString(R.string.bound));

        }

        if (accountSetting.getBankVerified() == 0) {
            tvUnionPay.setText(WonderfulToastUtils.getString(R.string.unbound));

        } else {
            tvUnionPay.setText(WonderfulToastUtils.getString(R.string.bound));
