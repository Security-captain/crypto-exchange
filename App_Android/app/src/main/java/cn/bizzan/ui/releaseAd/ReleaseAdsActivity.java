...
public class ReleaseAdsActivity extends BaseActivity implements ReleaseAdContract.View {
    ...
    private void maxChange() {
        ...
        if (!WonderfulStringUtils.isEmpty(maxLimit, price, number)) {
            ...
            if (Double.valueOf(maxLimit) > max) {
                WonderfulToastUtils.showToast(WonderfulToastUtils.getString(R.string.maxLimitTip) + max + "CNY");
            }
        }
    }
    ...
    private void showTimeLimitDialog() {
        if (timeLimitView == null) {
            ...
            timedialog = new AlertDialog.Builder(this, R.style.custom_dialog).setTitle(WonderfulToastUtils.getString(R.string.text_ad_fu_time)).setView(timeLimitView)
                    .setPositiveButton(WonderfulToastUtils.getString(R.string.dialog_sure), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            timeConfirm();
                        }
                    }).setNegativeButton(WonderfulToastUtils.getString(R.string.dialog_one_cancel), null).create();
        }
        timedialog.show();
    }
    ...
    private void change() {
        ...
        tvOverflow.setHint(WonderfulToastUtils.getString(R.string.text_ad_yi_two));
        etjyPrice.setText("");
        etjyPrice.setHint(WonderfulToastUtils.getString(R.string.text_ad_jiao_two));
        etjyPrice.setEnabled(false);
    }

    private void fix() {
        tvOverflow.setText("");
        tvOverflow.setHint(WonderfulToastUtils.getString(R.string.text_ad_yi_one));
        tvOverflow.setEnabled(false);
        etjyPrice.setText("");
        etjyPrice.setHint(WonderfulToastUtils.getString(R.string.text_ad_jiao_one));
...
//            WonderfulToastUtils.showToast("advertiseType=" + advertiseType + "  auto=" + auto + "  autoword=" + autoword);
    ...
    private void showPayWayDialog() {
        if (payWayView == null) {
            ...
            payWayDialog = new AlertDialog.Builder(this, R.style.custom_dialog).setTitle(WonderfulToastUtils.getString(R.string.text_ad_fu_kuan)).setView(payWayView)
                    .setPositiveButton(WonderfulToastUtils.getString(R.string.dialog_sure), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            payWayConfirm();
    ...
    private void showCoinInfoDialog() {
        if (coinInfoView == null) {
            ...
            dialog = new AlertDialog.Builder(this, R.style.custom_dialog).setTitle(WonderfulToastUtils.getString(R.string.text_ad_bi)).setView(coinInfoView)
                    .setPositiveButton(WonderfulToastUtils.getString(R.string.dialog_sure), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            coinInfoConfirm();
    ...
    protected void fillWidget() {
        if (advertiseType.equals("BUY")) {
            tvTitle.setText(WonderfulToastUtils.getString(R.string.text_ad_title));
            tvCountText.setText(WonderfulToastUtils.getString(R.string.text_ad_buy_num));
        } else if (advertiseType.equals("SELL")) {
            tvTitle.setText(WonderfulToastUtils.getString(R.string.text_ad_titles));
            tvCountText.setText(WonderfulToastUtils.getString(R.string.text_ad_sell_num));
        }
        if (ads == null) {
            tvRelease.setText(WonderfulToastUtils.getString(R.string.text_fa_bu));
        } else {
            tvTitle.setText(WonderfulToastUtils.getString(R.string.text_ad_change));
            tvRelease.setText(WonderfulToastUtils.getString(R.string.text_change));
        }
    }
    ...
    private void fillViews(Ads ads) {
        ...
        tvPayTime.setText(ads.getTimeLimit() + " " + WonderfulToastUtils.getString(R.string.text_ad_minu));
