 ...
 */
public class HeartSocket implements ISocket {

    private static HeartSocket groupSocket = null;
    ...
    public static final String ip = UrlConfig.HEART_URL;
    ...
    public static synchronized HeartSocket getInstance() {
        return groupSocket == null ? groupSocket = new HeartSocket() : groupSocket;
    }
