...
public class C2CBuyOrSellActivity extends BaseActivity implements C2CBuyOrSellContract.View, OrderConfirmDialogFragment.OperateCallback {
    ...
    protected void fillWidget() {
        if ("0".equals(c2cBean.getAdvertiseType())) {
            tvTitle.setText(WonderfulToastUtils.getString(R.string.text_chu_sho) + c2cBean.getUnit());
            tvInfo.setText(WonderfulToastUtils.getString(R.string.text_much_sale));
        } else {
            tvTitle.setText(WonderfulToastUtils.getString(R.string.text_gou_mai) + c2cBean.getUnit());
            tvInfo.setText(WonderfulToastUtils.getString(R.string.text_much_buy));
        }
        setButtonText();
    }
    ...
    private void setButtonText() {
        if ("0".equals(c2cBean.getAdvertiseType())) {
            if (MyApplication.getApp().isLogin()) {
                ...
                tvBuy.setText(WonderfulToastUtils.getString(R.string.text_chu_sho));
            } else {
                //tvContact.setVisibility(View.GONE);
                tvBuy.setText(WonderfulToastUtils.getString(R.string.text_to_login));
            }
        } else {
            if (MyApplication.getApp().isLogin()) {
                //tvContact.setVisibility(View.VISIBLE);
                tvBuy.setText(WonderfulToastUtils.getString(R.string.text_gou_mai));
            } else {
                //tvContact.setVisibility(View.GONE);
                tvBuy.setText(WonderfulToastUtils.getString(R.string.text_to_login));
            }
...
//        item.getTransactions()
        ...
        tvExchangeCount.setText(WonderfulToastUtils.getString(R.string.text_deal_num) + c2CExchangeInfo.getTransactions());
//        tvRemainAmount.setText(WonderfulToastUtils.getString(R.string.text_surplus_num)+new BigDecimal(c2CExchangeInfo.getMaxTradableAmount()));
        tvRemainAmount.setText(WonderfulToastUtils.getString(R.string.text_surplus_num) + c2CExchangeInfo.getNumber());
    }
