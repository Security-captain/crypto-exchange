...
public class OrderConfirmDialogFragment extends BaseDialogFragment {
    ...
    protected void fillWidget() {
        if ("0".equals(type)) {
            tvPriceText.setText(WonderfulToastUtils.getString(R.string.dialog_three_ones));
            tvCountText.setText(WonderfulToastUtils.getString(R.string.dialog_three_twos));
            tvTotalText.setText(WonderfulToastUtils.getString(R.string.dialog_three_threes));
        } else {
            tvPriceText.setText(WonderfulToastUtils.getString(R.string.dialog_three_one));
            tvCountText.setText(WonderfulToastUtils.getString(R.string.dialog_three_two));
            tvTotalText.setText(WonderfulToastUtils.getString(R.string.dialog_three_three));
        }
