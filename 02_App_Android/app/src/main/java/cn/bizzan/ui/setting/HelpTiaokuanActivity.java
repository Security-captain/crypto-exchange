 ...
 */
public class HelpTiaokuanActivity extends BaseActivity {
    @BindView(R.id.llTitle)
    LinearLayout llTitle;
    private GongGaoAdapter adapter;
    @BindView(R.id.listview_tiaokuan)
    LinListView listview_tiaokuan;
    ...
    protected int getActivityLayoutId() {
        return R.layout.activity_help_tiaokuan;
    }

    public static void actionStart(Context context) {
        Intent intent = new Intent(context, HelpTiaokuanActivity.class);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        listview_tiaokuan.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                MessageHelpActivity.actionStart(HelpTiaokuanActivity.this, messageList.get(position).getId());
            }
        });
    }
    ...
    private void getMessage() {
        WonderfulOkhttpUtils.post().url(UrlFactory.getHelpXinShou())
            ...
            public void onError(Request request, Exception e) {
                hideLoadingPopup();
                listview_tiaokuan.stopFreshing();
            }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonArray1.length() > 0) {
                        ...
                        adapter = new GongGaoAdapter(HelpTiaokuanActivity.this, messageList);
                        listview_tiaokuan.setEveryPageItemCount(20);
                        listview_tiaokuan.setAdapter(adapter);
                        listview_tiaokuan.setOnRefreshListener(new LinListView.OnRefreshListener() {
                            @Override
...
//        });
    ...
    protected void initImmersionBar() {
        ...
        if (!isSetTitle) {
            ImmersionBar.setTitleBar(HelpTiaokuanActivity.this, llTitle);
            isSetTitle = true;
        }
    }
}
