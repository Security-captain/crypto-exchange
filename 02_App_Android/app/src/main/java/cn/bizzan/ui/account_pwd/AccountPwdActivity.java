...
public class AccountPwdActivity extends BaseActivity implements cn.bizzan.ui.account_pwd.AccountPwdContract.View {
    ...
    private void accountPwd() {
        ...
        if (!jyPassword.equals(repeatPWd)) WonderfulToastUtils.showToast(WonderfulToastUtils.getString(R.string.pwd_diff));
