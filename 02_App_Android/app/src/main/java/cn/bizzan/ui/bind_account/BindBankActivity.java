...
public class BindBankActivity extends BaseActivity implements BindAccountContact.BankView {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        if (setting.getBankVerified() == 1) {
            ...
            tvTitle.setText(WonderfulToastUtils.getString(R.string.text_change) + WonderfulToastUtils.getString(R.string.unionpay_account));
        } else
            tvTitle.setText(WonderfulToastUtils.getString(R.string.binding) + WonderfulToastUtils.getString(R.string.unionpay_account));
...
//            dialog = new AlertDialog.Builder(this).setTitle(WonderfulToastUtils.getString(R.string.bank)).setView(coinInfoView)
//                    .setPositiveButton(WonderfulToastUtils.getString(R.string.confirm), new DialogInterface.OnClickListener() {
//                        @Override
//                        public void onClick(DialogInterface dialog, int which) {
//                            Confirm();
//                        }
//                    }).setNegativeButton(WonderfulToastUtils.getString(R.string.cancle), null).create();
//        }
//        dialog.show();
        //条件选择器
        OptionsPickerView pvOptions = new OptionsPickerBuilder(BindBankActivity.this, new OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int option2, int options3, View v) {
                ...
                .setTitleText("开户银行").setTitleColor(Color.WHITE)
