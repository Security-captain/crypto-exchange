...
//    }
    ...
    private void initSpinners() {
        ...
        sp_type.attachDataSource(new LinkedList<>(Arrays.asList(WonderfulToastUtils.getStringArray(R.array.text_type_array))));
        sp_type.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    type = WonderfulToastUtils.getStringArray(R.array.text_type_param)[position];
                }
            }
        ...
        //方向选择（买0，卖1）
        sp_direction.attachDataSource(new LinkedList<>(Arrays.asList(WonderfulToastUtils.getStringArray(R.array.text_direction))));
