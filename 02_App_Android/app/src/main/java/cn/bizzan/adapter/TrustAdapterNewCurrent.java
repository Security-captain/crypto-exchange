...
public class TrustAdapterNewCurrent extends BaseQuickAdapter<EntrustHistory, BaseViewHolder> {
    boolean isCurrent;

    public TrustAdapterNewCurrent(@Nullable List<EntrustHistory> data, boolean isCurrent) {
