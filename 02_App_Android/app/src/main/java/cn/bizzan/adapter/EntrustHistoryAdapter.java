    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        if (holder instanceof RecyclerViewHolder) {
            ...
            if (historyList.get(i).getDirection().equals("BUY")) {
                recyclerViewHolder.tvChildType.setText(WonderfulToastUtils.getString(R.string.text_buy));
                recyclerViewHolder.tvChildType.setTextColor(context.getResources().getColor(R.color.typeGreen));
            }else {
                recyclerViewHolder.tvChildType.setText(WonderfulToastUtils.getString(R.string.text_sale));
            ...
            if (historyList.get(i).getStatus().equals("COMPLETED")) {
                recyclerViewHolder.tvChildState.setText(WonderfulToastUtils.getString(R.string.traded_trade));
                ...
                recyclerViewHolder.tvChildState.setText(WonderfulToastUtils.getString(R.string.undone));
                recyclerViewHolder.ivChildGo.setVisibility(View.INVISIBLE);
            }else {
                recyclerViewHolder.tvChildState.setText(WonderfulToastUtils.getString(R.string.trading));
                recyclerViewHolder.ivChildGo.setVisibility(View.INVISIBLE);
            }
            ...
            if (historyList.get(i).getType().equals("MARKET_PRICE")) {
                recyclerViewHolder.tvChildPrice.setText(WonderfulToastUtils.getString(R.string.marketPrice));
